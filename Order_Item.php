...
<head>
    ...
    <title>Order item -Suwani Pharmacy</title>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
                        ...
                        {?>
							<div class = "row">
								...
								<div class ="col-md-10">
                                    ...
                                    padding-bottom: -10px;padding-top: 6px;font-family: Alef, sans-serif;text-align: center;padding-left: -65px;padding-right: 670px;" >Order Items</h2>
								</div>
								</div>
                            <?php
                        }
            ...
            <div class="text-center">
                ...
                <form action="logic/order_reg.php" method="post" enctype="multipart/form-data">
                        ...
                        <fieldset style="width: 542px;"></fieldset>
                        <div class="form-row text-left" style="padding-left: 50px; padding-top:0px; margin-top:10px;height: 227px;">
                            <div class="col-md-6" id="message" style="width: 349px;height: 227px;min-width: 0px;">

                          
                                 <div class="form-group has-feedback" style="height: 40px;width: 350px; font-size: 20px;"><input class="form-control"  style="width: 400px"  value="<?php echo $OrderId; ?>"  name="order_id" id="order_id" placeholder="order id" required></div>

                                <div class="form-group has-feedback" style="height: 40px;width: 350px; font-size: 20px;"><input class="form-control"  style="width: 400px"  value="<?php echo $CompanyId; ?>"  name="company_id" id="company_id"  placeholder="company id" required ></div>

                                <div class="form-group has-feedback" style="height: 40px;width: 350px; font-size: 20px;"><input class="form-control"  style="width: 400px" type="email" value="<?php echo $Email; ?>"  name="email" id="email"  placeholder="email" required></div>

                                <div class="form-group has-feedback" style="height: 40px;width: 350px; font-size: 20px;"><input class="form-control"  style="width: 400px"  value="<?php echo $ItemName; ?>" name="item_name" id="item_name" placeholder="item name" required></div>

                                <div class="form-group has-feedback" style="height: 40px;width: 350px; font-size: 20px;"><input class="form-control"  style="width: 400px" value="<?php echo $ItemId; ?>" name="item_id" id="item_id"  placeholder="item id" required></div>

                                <div class="form-group has-feedback" style="height: 40px;width: 350px; font-size: 20px;"><input class="form-control"  style="width: 400px" value="<?php echo  $Quantity; ?>" id="quantity" name="quantity" placeholder="quantity" required></div>

                                <div class="form-group has-feedback" style="height: 40px;width: 350px; font-size: 20px;"><input class="form-control"  style="width: 400px" value="<?php echo $Date; ?>"  id="date" name="date" type="date" min="2020-01-01" required></div>
                                ...
                                <button class="btn btn-primary border rounded" type="submit" id="button" style="layout-top:-50px; margin-left: 100px; margin-top: 10px; width: 162px;height:40px; background: #002649;font-size: 18px;">Order Item</button>
                                </div> 
                        ...
                        <img src="assets/img/item_order.jpg"  style="width:400px; height:400px; margin-left: 550px; margin-top: -240px;">
                </form>
         ...
         if(isset($_GET['sucess'])){
            //if querry excuted succesfully
                if($_GET['sucess']=='yes'){
                    $message = "The order has been succesfully sent";
