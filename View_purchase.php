...
<head>
    ...
    <title>View Purchase-Suwani Pharmacy</title>
...
<body id="page-top">
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div>
                <a role="button" style="padding-left:20px; padding-top:10px; width:200px;height: 50px;border-color: #002649;margin-left: 900px;margin-top: -10px;background: rgb(51, 0, 20)"; href="../pdf/Purchase_Report.php" class="btn btn-primary border rounded" >Generate Reports</a> <br><br><br>
            </div>

            <div class="container-fluid">
                <h3 class="text-dark mb-1" style="font-size: 28px; margin-top: -95px; color: #3a75c4;padding-bottom: -11px;font-family: Nunito, sans-serif;">Previous Purchase</h3>
            </div>
            <div class="col-md-12 search-table-col" style="margin: -8px;padding-top: -40px;margin-top: 2px;margin-top: 0px;">
                <div class="form-group pull-right col-lg-4"><input type="text" class="search form-control" placeholder="Search by typing here.."></div><span class="counter pull-right"></span>
                <div class="row" style="width: 931px;height: 72px;">
                <div class="col" style="width: 200px;height: 47px;margin-top: -35px;"><a class="btn btn-primary border rounded" role="button" style="background: #002649;height: 45px;width: 146px;" href="Add_Purchase.php">+ Add Purchase</a></div>
            </div>
                <div class="table-responsive table-bordered table table-hover table-bordered results" style="margin-left: 11px;margin-top: -35px;">
                    <table class="table table-bordered table-hover" style="margin-top: 0px;">
                        <thead class="bill-header cs">
                            <tr style="background: #505e6c;font-size: 17px;">
                            <th style="width: 264px;">Item ID</th>
                                            <th>Purchased ID</th>
                                            <th>Quantity</th>
                                            <th>Company ID</th>
                                            <th>Ordered date</th>
                        ...
                        <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['purchased_id']; ?></td>
                                            ...
                                            <td class="d-xl-flex justify-content-xl-start" style="width: 217px;border-style: none;border-color: rgba(255,255,255,0);">
                                               ...
                                               <!-- <a class="btn btn-primary border rounded" role="button" style="background: #009e49;margin-bottom: 1px;" href="Add_Purchase.php?id=<?php echo $row["purchased_id"];?>"><i class="icon ion-edit"></i></a> -->
                                            <!-- table row button delete -->
                                                <a class="btn btn-primary border rounded" role="button" style="background: #c41e3a;padding-bottom: 6px;padding-top: 6px;margin-bottom: 0px;" href="./logic/purchase_delete.php?purchaseid=<?php echo $row['purchased_id']; ?>" ><i class="fa fa-trash-o"></i></a>
	...
	//if querry excuted succesfully
		if($_GET['delete']=='yes'){
			$message = "The Purchase has been deleted succesfully";
