...
<head>
    ...
    <title>Order Items-Suwani Pharmacy</title>
...
<?php
        ...
        $OrderId = isset($_REQUEST['id']) ? $_REQUEST['id'] : ""; // get value from url parameter, id
        $CompanyId = "";
        $Email = "";
		$ItemName= "";
		$ItemId="";
    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <?php
                        ...
                        {?>
							<div class = "row">
								...
								<div class ="col-md-10">
									<h2 class="text-center" style="color: #002649;background: url(&quot;assets/img/New%20Folder/background_add_supplier.jpg&quot;), rgba(0,38,73,0.01);height: 50px;padding-bottom: -10px;padding-top: 6px;font-family: Alef, sans-serif;text-align: center;padding-left: -65px;padding-right: 670px;">Order Items</h2>
								</div>
								</div>
                            <?php
                        }
            ...
            <div class="container">
                <div>
                    ...
                    <form action="logic/order_reg.php" method="post" enctype="multipart/form-data">
                        <div class="form-group border-success" style="padding-top: 12px;" >
                            <div  data-toggle="tooltip"  id="formdiv" style="background: linear-gradient(white 14%,  100%);">
                                <div class="form-row" style="margin-right:30px;margin-left:0px;padding-top:24px;">
                                    <div class="col-md-8 offset-md-1">
                                        <p style="margin-left: 2%;font-family: Roboto, sans-serif;font-size: 20px;"><strong>Order ID</strong></p>
                                    </div>
                                    <div class="col-md-10 offset-md-1"><input class="form-control" type="text" style="margin-left:0px;font-family:Roboto, sans-serif;" value="<?php echo $OrderId; ?>"  name="order_id" id="order_id"  placeholder="order id" required></div>
                                </div>
                                ...
                                <div class="form-row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                                    ...
                                    <div class="col-md-10 offset-md-1"><input class="form-control" type="text" style="margin-left:0px;font-family:Roboto, sans-serif;" value="<?php echo $CompanyId; ?>"  name="company_id" id="company_id" placeholder="company id" required></div>
                                </div>
                                <div class="form-row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                                    <div class="col-md-8 offset-md-1">
                                        <p style="margin-left: 2%;font-family: Roboto, sans-serif;font-size: 20px;"><strong>Email</strong></p>
                                    </div>
                                    <div class="col-md-10 offset-md-1"><input class="form-control" type="email" style="margin-left:0px;font-family:Roboto, sans-serif;" value="<?php echo $Email; ?>"  name="email" id="email"  placeholder="email" type = "email" required></div>
                                </div>
                                <div class="form-row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                                    <div class="col-md-8 offset-md-1">
                                        <p style="margin-left: 2%;font-family: Roboto, sans-serif;font-size: 20px;"><strong>Item Name</strong></p>
                                    </div>
                                    <div class="col-md-10 offset-md-1" style="font-family:Roboto, sans-serif;"><input class="form-control"  style="margin-left:0px;" value="<?php echo $ItemName; ?>" name="item_name" id="item_name"  placeholder="item name" required></div>
                                </div>
                                <div class="form-row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                                    <div class="col-md-8 offset-md-1">
                                        <p style="margin-left: 2%;font-family: Roboto, sans-serif;font-size: 20px;"><strong>Item ID</strong></p>
                                    </div>
                                    <div class="col-md-10 offset-md-1"><input class="form-control" type="text" style="margin-left:0px;font-family:Roboto, sans-serif;" placeholder="item id" value="<?php echo $ItemId; ?>" name="item_id" id="item_id"  required></div>
                                </div>
                                <div class="form-row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                                    <div class="col-md-8 offset-md-1">
                                        <p style="margin-left: 2%;font-family: Roboto, sans-serif;font-size: 20px;"><strong>Quantity</strong></p>
                                    </div>
                                    <div class="col-md-10 offset-md-1"><input class="form-control" style="font-family:Roboto, sans-serif;"  value="<?php echo  $Quantity; ?>" id="quantity" name="quantity" placeholder= "quantity" required></div>
                                </div>

                                <div class="col-md-8 offset-md-1">
                                        <p style="margin-left: 2%;font-family: Roboto, sans-serif;font-size: 20px;"><strong> Date</strong></p>
                                    </div>
                                    <div class="col-md-10 offset-md-1"><input class="form-control" style="font-family:Roboto, sans-serif;" type="date" value="<?php echo $Date; ?>"  id="date" name="date" required></div>
                                </div>
                                ...
                                <div class="col-md-8 offset-md-1">
                                    ...
                                    if (isset($_REQUEST["id"])) {
                                        // Hidden field will be added to the form only if the parameter id is set
                                        ?>
                                            <input class="form-control" type="hidden"  name="isUpdate" value="<?php echo $OrderId;?>" style="width: 150px;"></div>
                                            <?php
                                    }
                                    ?>
                                    ...
                                    <div class="col-md-8 offset-md-1">
                                    <input style="margin-top: 10px;margin-left: 386px;width: 100px;height: 45px;margin-bottom: 0px;background: #002649;font-size: 18px;border-color: #002649;" class="btn btn-primary border rounded" type="submit" id="button" value="Save" />
                                    </div> 
        ...
        //if page is redirected by save customer.php then we check the parameter
            ...
            //if querry excuted succesfully
                if($_GET['sucess']=='yes'){
                    $message = "The order has been succesfully added to the database";
