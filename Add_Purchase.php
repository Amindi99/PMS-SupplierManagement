...
<head>
    ...
    <title>Add Purchase-Suwani Pharmacy</title>
...
<?php
        ...
        // create variables to store purchased details
        $purchasedId = isset($_REQUEST['id']) ? $_REQUEST['id'] : ""; // get value from url parameter, id
        $itemId = "";
        $itemName = "";
		$Quantity = "";
		$companyId="";
        ...
        $sql = "SELECT * FROM add_purchase WHERE purchased_id ='" . $purchasedId . "'";
    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <?php
                        ...
                        if (isset($_REQUEST["id"])) {
							...
							<div class = "row">
								...
								<div class =" col-md-1">
									<a href= "View_purchase.php"> <Button class = "btn-secondry"  ><i class="fa fa-arrow-left" aria-hidden="true"></i> </button> </a>
								</div>
								<div class ="col-md-10">
									<h2 class="text-center" style="color: #002649;background: url(&quot;assets/img/New%20Folder/background_add_supplier.jpg&quot;), rgba(0,38,73,0.01);height: 50px;
                                    padding-bottom: -10px;padding-top: 6px;font-family: Alef, sans-serif;text-align: center;padding-left: -65px;padding-right: 670px;">Update Purchase</h2>
                                </div>
								</div>
                                <?php
                        }else
                        {?>
							<div class = "row">
								...
								<div class ="col-md-10">
									<h2 class="text-center" style="color: #002649;background: url(&quot;assets/img/New%20Folder/background_add_supplier.jpg&quot;), rgba(0,38,73,0.01);height: 50px;
                                    padding-bottom: -10px;padding-top: 6px;font-family: Alef, sans-serif;text-align: center;padding-left: -65px;padding-right: 670px;">Add Purchase</h2>
								</div>
								</div>
                            <?php
                        }
            ...
            <div class="container">
                <div>
                    ...
                    <form action="logic/purchase_reg.php" method="post" enctype="multipart/form-data" >
                        <div class="form-group border-success" style="padding-top: 12px;">
                            ...
                            <div class="form-row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                                    <div class="col-md-8 offset-md-1">
                                        <p style="margin-left: 2%;font-family: Roboto, sans-serif;font-size: 20px;"><strong>Purchased ID</strong></p>
                                    </div>
                                    <div class="col-md-10 offset-md-1"><input class="form-control" type="text" style="margin-left:0px;font-family:Roboto, sans-serif;" value="<?php echo $purchasedId; ?>" name="purchased_id" id="purchased_id"  placeholder="Purchased ID" required></div>
                                </div>

                                <div class="form-row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                                    <div class="col-md-8 offset-md-1">
                                        <p style="margin-left: 2%;font-family: Roboto, sans-serif;font-size: 20px;"><strong>Item ID</strong></p>
                                    </div>
                                    <div class="col-md-10 offset-md-1"><input class="form-control" type="text" style="margin-left:0px;font-family:Roboto, sans-serif;" value="<?php echo $itemId; ?>" name="item_id" id="item_id"  placeholder="Item ID" required></div>
                                </div>

                                <div class="form-row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                                    <div class="col-md-8 offset-md-1">
                                        <p style="margin-left: 2%;font-family: Roboto, sans-serif;font-size: 20px;"><strong>Quantity</strong></p>
                                    </div>
                                    <div class="col-md-10 offset-md-1"><input class="form-control" type="text" style="margin-left:0px;font-family:Roboto, sans-serif;" value="<?php echo $Quantity; ?>" name="quantity" id="quantity"  placeholder="Quantity" required></div>
                                </div>

                                <div class="form-row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                                    <div class="col-md-8 offset-md-1">
                                        <p style="margin-left: 2%;font-family: Roboto, sans-serif;font-size: 20px;"><strong>Company ID</strong></p>
                                    </div>
                                    <div class="col-md-10 offset-md-1"><input class="form-control" type="tel" style="margin-left:0px;font-family:Roboto, sans-serif;" value="<?php echo $companyId; ?>" name="company_id" id="company_id"  placeholder="Company Id" required></div>
                                </div>

                                <div class="form-row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                                    <div class="col-md-8 offset-md-1">
                                        <p style="margin-left: 2%;font-family: Roboto, sans-serif;font-size: 20px;"><strong>Ordered Date</strong></p>
                                    </div>
                                    <div class="col-md-10 offset-md-1"><input class="form-control" style="font-family:Roboto, sans-serif;" type="date" min="2020-01-01" value="<?php echo  $orderedDate; ?>" name="ordered_date" id="ordered_date" ></div>
                                </div>

                                <div class="form-row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                                    <div class="col-md-8 offset-md-1">
                                        <p style="margin-left: 2%;font-family: Roboto, sans-serif;font-size: 20px;"><strong>Received Date</strong></p>
                                    </div>
                                    <div class="col-md-10 offset-md-1"><input class="form-control" style="font-family:Roboto, sans-serif;" type="date" value="<?php echo  $receivedDate; ?>" name="received_date" id="received_date" ></div>
                                </div>
                                ...
                                <div class="col-md-8 offset-md-1">
                                    ...
                                    if (isset($_REQUEST["id"])) {
                                        // Hidden field will be added to the form only if the parameter id is set
                                        ?>
                                            <input class="form-control" type="hidden"  name="isUpdate" value="<?php echo $purchasedId;?>" style="width: 150px;"></div>
                                            <?php
                                    }
                                    ?>
                                    ...
                                    <div class="col-md-8 offset-md-1">
                                    <input style="margin-top: 30px;margin-left: 246px;width: 100px;height: 55px;margin-bottom: 0px;background: #002649;font-size: 22px;border-color: #002649;" class="btn btn-primary border rounded" type="submit" name="submit_image" id="button" value="Save" />
                                    </div>
                                </div>
        ...
        //if page is redirected by saving then we check the parameter
                if(isset($_GET['sucess'])){
            //if querry excuted succesfully
                if($_GET['sucess']=='yes'){
                    $message = "The purchased item has been succesfully added to the database";
                ...
                if(isset($_GET['delete'])){   
                        if($_GET['delete']=='yes')
                     {
                   $message = "Purchased was deleted successfully";
                  echo "<script type='text/javascript'>alert('$message');</script>";
                       }
